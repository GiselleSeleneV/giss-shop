...
export const FilterSidebar = () => {
  ...
  const currentSizes = searchParams.get("sizes")?.split(",") || []; // ["xs", "s", "m", "l", "xl", "xxl"]
  ...
  return (
    <div className="w-full lg:w-64 space-y-8">
      <div>
        <h3 className="font-montserrat text-lg font-light tracking-[0.16em] uppercase text-navy mb-1">
          Filtros
        </h3>
      ...
      <div className="space-y-4">
        <h4 className="text-sm font-medium tracking-wide text-navy">Tallas</h4>
      ...
      {/* Price Range */}
      <div className="space-y-4">
        <h4 className="text-sm font-medium tracking-wide text-navy">Precio</h4>
        <RadioGroup
          value={currentPrice}
